...
urlpatterns = [
    ...
    path('panel/<path:username>/', views.admin_detail, name='admin_detail'),
    path('panel/<path:username>/set-limit/', views.set_limit, name='set_limit'),
    path('panel/<path:username>/remove-limit/', views.remove_limit, name='remove_limit'),
    path('panel/<path:username>/action/', views.admin_action, name='admin_action'),
